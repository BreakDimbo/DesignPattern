package com.limbo.dp.dynamic_proxy.compiler.test;

import com.limbo.dp.dynamic_proxy.Movable;
import com.limbo.dp.dynamic_proxy.Tank;
    ...
    public static void main(String[] args) throws Exception {
        ...
        String str =
                "package com.limbo.dp.dynamic_proxy;" +
                        ...
                        "}";
        //写出 java 文件
        String filename = System.getProperty("user.dir") + "/src/com/limbo/dp/dynamic_proxy/TankTimeProxy.java";
//System.out.println(filename);
        ...
        Class c = ul.loadClass("com.limbo.dp.dynamic_proxy.TankTimeProxy");
